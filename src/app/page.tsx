    ...
    <div className="px-4 sm:px-6 lg:px-[100px]">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6 mt-10" id="about">
        ...
        <div className="animate-slide-rigth w-full lg:w-1/2">
          ...
          <p className="text-sm sm:text-base">
            Мы открыли еще один магазин: «Оптика на Профсоюзной 20/9»!
            <br />
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center gap-6 mt-16" id="more_about">
        <div className="animate-slide-left w-full lg:w-1/2">
          ...
          <p className="text-sm sm:text-base">
            В «Оптике на Комсомольском, 37» и «Оптике на Профсоюзный, 20/9» представлен прекрасный выбор оправ и солнцезащитных очков для мужчин, женщин, детей и подростков ведущих
            производителей. Качество Вашего зрения определяют именно очковые линзы. Вам предложат подходящие для Вас линзы с различными характеристиками, обеспечивающие комфорт и
            превосходное зрение на разных расстояниях ведущих производителей: Carl Zeiss (Германия); Rodenstock (Германия); Seiko (Япония), Тоkai (Япония); Essilor (Франция);
            Optimize (Израиль); Shamir (Израиль):
